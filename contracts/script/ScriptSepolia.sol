...
contract ScriptDeploySepolia is Script {
    ...
    function run() public {
        ...
        UserSlotFactory slotFactory = new UserSlotFactory(aavePool, poolDataProvider, address(ccipConnector), GHO);
...
//forge script script/ScriptSepolia.sol:ScriptDeploySepolia --rpc-url $SEPOLIA_RPC_URL --broadcast --verify -vvvv --via-ir
